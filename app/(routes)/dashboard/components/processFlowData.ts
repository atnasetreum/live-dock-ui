...
export const processSteps: ProcessFlowStep[] = [
  ...
  {
    id: "security-pending-ticket",
    lane: "security",
    column: 5,
    title: "Pendiente de entrega de ticket",
    emphasis: "outlined",
  },
  {
    id: "security-delivered-ticket",
    lane: "security",
    column: 6,
  ...
  },
  {
    ...
    lane: "logistics",
    column: 7,
    title: "Pendiente de captura de peso en SAP",
    emphasis: "outlined",
  },
  {
...
export const processConnections: ProcessFlowEdge[] = [
  ...
  {
    id: "edge-deliver-ticket",
    source: "production-downloaded",
    target: "security-pending-ticket",
    dashed: true,
  },
  {
    id: "edge-deliver-ticket",
    source: "security-pending-ticket",
    target: "security-delivered-ticket",
    dashed: true,
  },
  {
    id: "edge-sap-capture",
    source: "security-delivered-ticket",
